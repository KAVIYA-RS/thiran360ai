...
function About() {
  return (
    <div className="about-content">
      <h1>Welcome to Thiran360, the crunchy delight makers!</h1>
      <p>
        At Thiran360, we're passionate about crafting scrumptious crackers that bring people together.
      ...
      <div className="team-photos">
        {/* Insert team member photos and brief descriptions */}
        <img src="path_to_photo1" alt="Team Member 1" />
        <img src="path_to_photo2" alt="Team Member 2" />
        <img src="path_to_photo3" alt="Team Member 3" />
      </div>
